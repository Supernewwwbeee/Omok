...
public class Team6Player implements OMGPlayable, OMG33Testable {
    ...
    private static final int MINIMAX_TIME_LIMIT = 2000; // Minimax 알고리즘 시간 제한 
    private static final int OPTIMAL_POINT_TIME_LIMIT = 200; // calculateOptimalPoint 알고리즘 시간 제한
