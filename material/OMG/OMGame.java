...
public class OMGame {
	...
	private static String player1fullname = "testteam.ConsolePlayer";
	private static String player2fullname = "testteam.RandomPlayer";
	...
	public String play(int _mode) 
	{
		...
		while (true) {
			...
			do {
				log_verboseBasic("\nTo Quit:-1 y");
				if (count % 2 == 1) {
					log_verboseBasic("�� BLACK's turn");
				} else {
					log_verboseBasic("�� WHITE's turn");
				}
